...
lecture. Le bouton au casque barré bypass le clip dans toute séquence démarrée
...
réglages permet de modifier le nom et la couleur. L’action « Concatenate clips »
...
groupe lance son premier clip descendant non bypassé et reste actif pendant l’enchaînement
...
L’enchaînement suit l’ordre des cartes en sautant les clips bypassés, sauf si la boucle ou le bouton global
