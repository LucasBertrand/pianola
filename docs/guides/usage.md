...
Undo/Redo.
La timeline permet d'ajouter un nombre spécifique de mesures avant ou après la mesure courante, et d'éditer les marqueurs (tempo, métrique, gamme, section). L'ajout au playhead reste disponible pendant la lecture : sa position audio continue est capturée à l'ouverture puis projetée une fois sur la grille musicale active. Cette projection peut atteindre exactement la fin du clip ; les marqueurs ponctuels de tempo, gamme et section peuvent y être ajoutés ou déplacés. Le brouillon ne suit ensuite plus le playhead et le document n'est modifié qu'à la confirmation. Un marqueur de section attache un commentaire à un tick du clip ; il se sélectionne, se déplace et se copie comme les marqueurs de tempo et de gamme.
