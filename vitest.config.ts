  ...
  test: {
    coverage: {
      ...
      include: [
        ...
        "src/presentation/dialogs/InstrumentPresetDialog.tsx",
        "src/presentation/inspector/clips/ClipInspector.tsx",
        "src/presentation/piano-roll/PianoRollWorkspace.tsx",
      ],
