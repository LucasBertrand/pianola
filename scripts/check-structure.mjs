...
const forbiddenPaths = [
  ...
  "src/domain/personal-instrument-presets.ts",
  "src/domain/project-instrument-factory.ts",
  "src/domain/instruments/instrument.ts",
  "src/domain/instruments/instrument-constants.ts",
  "src/domain/validation/instrument-validation.ts",
  "src/domain/validation/project-instrument-value-validation.ts",
  "src/editor",
  "src/editor-core/piano-roll",
  "src/use-cases",
  "src/application/notes",
  "src/application/selection",
  "src/infrastructure/persistence/codecs/migrations",
  "src/infrastructure/persistence/migrations",
  "src/infrastructure/project-files/pianola/migrations",
  "src/infrastructure/versioned-data",
  "src/infrastructure/audio/worklet/polyblep-oscillator.ts",
  "src/infrastructure/audio/worklet/sample-envelope.ts",
  "src/infrastructure/audio/worklet/subtractive-worklet-voice.ts",
  "src/infrastructure/audio/playback-model.ts",
  "src/infrastructure/audio/playback-snapshot.ts",
  "src/infrastructure/audio/playback-source.ts",
  "src/infrastructure/audio/instrument-preview-policy.ts",
  "src/infrastructure/audio/worklet/synth",
  "src/infrastructure/audio/__tests__/subtractive-worklet-voice-preview.test.ts",
